...
```{r read_bootstraps}
#sets <- c("scramble", "NCAPD2", "NCAPD3", "SMC2", "RAD21", "WAPL48")
sets <- c("scramble")
...
```{r bootstrap_fit_params, fig.width=8, fig.height=3}
...
Note on terminology: I refer to individual boxes in cell tracks as "boxes" or "points". I refer to chains of consequtive boxes of the same type as "events".
...
The blue open bars show the expected distribution of duration of events derived from a random distribution of single brown points (noise). It shows that longer events (3 minutes or longer) are overrepresented, by comparison with random noise. Brown occurences cannot be explained by pure noise, they do form longer non-random "events".
