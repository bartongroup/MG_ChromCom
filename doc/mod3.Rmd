...
The model is going to be very simple. It consists of three states and only forward transitions are allowed. This way we can reduce the number of free parameters. In addition, transitions are allowed only at certain time periods (see table below).
