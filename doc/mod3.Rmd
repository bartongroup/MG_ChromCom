...
First, I allow for $t_1$, $k_1$ nad $k_2$ to be free. $\Delta t_2$, $\Delta t_3$ and $k_3$ are fixed at zero. Then, I repeat the fit with $\Delta t_2$ allowed to be free. The three-parameter model result is on the left, the four-parameter model is on the right.
