...
After a few days off work due to illnes, I'm putting all of this together in the mod3 document. The original model (ref1) needs to be re-fitted on the smae time interval as the new one. Running fits agai.
