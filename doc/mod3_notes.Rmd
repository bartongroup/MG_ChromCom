...
pars <- c3pars()
free <- c("t1", "k1", "k2", "dt2")
chr.scr.dt2 <- cacheData("fit_scramble_n3000_t1_k1_k2_dt2", fitChr, echr.scr, pars, free, nsim=3000, ntry=32, ncores=8, binDir=binDir)
...
pars <- chr.scr$pars
free <- c("k2", "dt2")
chr.d2.dt2 <- cacheData("fit_NCAPD2_n3000_k2_dt2", fitChr, echr.d2, pars, free, nsim=3000, ntry=16, ncores=8, binDir=binDir)
plotTimelines(chr.d2.dt2, expdata = echr.d2, withpars=TRUE)
```
