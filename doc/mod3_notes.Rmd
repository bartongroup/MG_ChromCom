...
plotTimelines(chr.scr, expdata = echr, withpars=TRUE)
```
### NCAPD2
...
plotTimelines(chr.d2, expdata = echr, withpars=TRUE)
```
...
plotTimelines(chr.d2.f, expdata = echr, withpars=TRUE)
```
...
plotTimelines(chr.d3, expdata = echr, withpars=TRUE)
```
